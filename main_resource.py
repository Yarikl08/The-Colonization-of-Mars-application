...
def main():
    ...
    api.add_resource(users_resource.UsersListResource, '/api/v2/users')  # для списка объектов
    api.add_resource(users_resource.UsersResource,
                     '/api/v2/users/<int:user_id>')  # для одного объекта
    api.add_resource(jobs_resource.JobsListResource, '/api/v2/jobs')  # для списка объектов
    api.add_resource(jobs_resource.JobsResource,
                     '/api/v2/jobs/<int:job_id>')  # для одного объекта
